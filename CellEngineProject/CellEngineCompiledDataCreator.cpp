...
void CellEngineCompiledDataCreator::AddChemicalReactions()
{
    try
    {
        ...
        CellEngineChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(1101, "STD ONLY WITH SEQ", "CH3CH2(OH) + DNA + ", {{5, 1, "", true }, {10001, 1, DNASequenceForTestFindingDNA, false } }, {{10, 1, "", true } }, nullptr, "standard normal reaction example"));

        CellEngineChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(10, "CUT 1 SEQ", "CH3CH2(OH) + DNA + ", {{5, 1, "", false }, {10001, 1, DNASequence1ForTestCutLink1, false } }, {}, &CellEngineChemicalReactionsInSimulationSpace::CutDNAInChosenPlaceSpecialReactionFunction, "only in presence of chosen sequence of DNA"));

        CellEngineChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(20, "LINK 1 SEQ", "CH3CH2(OH) + DNA + DNA + ", {{5, 1, "", false }, {10001, 1, DNASequence1ForTestCutLink1, false }, {10001, 1, DNASequence2ForTestCutLink1, false } }, {}, &CellEngineChemicalReactionsInSimulationSpace::LinkDNAInChosenPlaceSpecialReactionFunction, "links one strand of DNA with 2 endings with chosen sequences"));
        CellEngineChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(30, "LINK 1 ANY", "CH3CH2(OH) + DNA + DNA + ", {{5, 1, "", false }, {10001, 2, DNASequence1ForTestCutLink1Any, false } }, {}, &CellEngineChemicalReactionsInSimulationSpace::LinkDNAInAnyPlaceSpecialReactionFunction, "link one strand of DNA with 2 endings with any sequence"));
        ...
        CellEngineChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(1001, "STD", "C6H12O6 + O2 + ", {{1, 1, "", true }, {2, 6, "", true } }, {{3, 6, "", true }, {0, 6, "", true } }, nullptr));
        CellEngineChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(1002, "STD", "CH2CH2 + H2O + ", {{4, 1, "", true }, {0, 1, "", true } }, {{5, 1, "", true } }, nullptr));
        CellEngineChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(1003, "STD", "CH3CHCH2 + HX + ", {{6, 1, "", true }, {7, 1, "", true } }, {{8, 1, "", true } }, nullptr));
        CellEngineChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(1004, "STD", "CH2CH2 + O + ", {{4, 1, "", true }, {11, 1, "", true } }, {{10, 1, "", true } }, nullptr));
