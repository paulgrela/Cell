...
void CellEngineCompiledDataCreator::AddChemicalReactions()
{
    try
    {
        ...
        ChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(150, "POLYMERASE DNA START SEQ", "CH3CH2(OH)+DNA+", { { 5, 1, "", false }, { CellEngineConfigDataObject.DNAIdentifier, 1, "CTCATTT", false } }, {}, &CellEngineChemicalReactionsInSimulationSpace::PolymeraseRNAStartSpecialReactionFunction, "links particle with DNA when found sequence and joins first nucleotide "));
        ChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(160, "POLYMERASE DNA CONTINUE", "CH3CH2(OH)+DNA+", { { 5, 1, "", false, { CellEngineConfigDataObject.RNAIdentifier, CellEngineConfigDataObject.DNAIdentifier } } }, {}, &CellEngineChemicalReactionsInSimulationSpace::PolymeraseRNAContinueSpecialReactionFunction, "links new nucleotide that fits nucleotide in DNA if free nucleotides are found in proximity"));
