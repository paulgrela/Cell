...
void CellEngineCompiledDataCreator::AddChemicalReactions()
{
    try
    {
        ...
        ChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(171, "RIBOSOME RNA START SEQ", "GTP+R70S+RNA+", { { ParticlesKindsManagerObject.GetParticleKindFromStrId("particle_RIBOSOME")->EntityId, 1, "", false },  { ParticlesKindsManagerObject.GetParticleKindFromStrId("ProteinInBuildingProcess")->EntityId, 1, "", false }, { CellEngineConfigDataObject.RNAIdentifier, 1, RNAStartSequence, false }, { ParticlesKindsManagerObject.GetParticleKindFromStrId("M_gtp_c")->EntityId, 1, "", true } }, { }, &CellEngineChemicalReactionsInSimulationSpace::RibosomeTranslationStartSpecialReactionFunction, "links ribosome particle with RNA when found sequence and joins first nucleotide "));
...
void CellEngineCompiledDataCreator::AddTestChemicalReactions()
{
    try
    {
        ...
        ChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(150, "POLYMERASE RNA START SEQ", "Ethanol+DNA+RNA+", { { ParticlesKindsManagerObject.GetParticleKindFromStrId("Ethanol")->EntityId, 1, "", false }, { CellEngineConfigDataObject.DNAIdentifier, 1, "AACTAAC", false }, { CellEngineConfigDataObject.DNAIdentifier, 0, RNAStartSequence, false } }, {}, &CellEngineChemicalReactionsInSimulationSpace::PolymeraseRNATranscriptionStartSpecialReactionFunction, "links particle with DNA when found sequence and joins first nucleotide "));
        //ChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(150, "POLYMERASE RNA START SEQ", "Ethanol+DNA+", { { ParticlesKindsManagerObject.GetParticleKindFromStrId("Ethanol")->EntityId, 1, "", false }, { CellEngineConfigDataObject.DNAIdentifier, 1, "AACTAAC", false } }, {}, &CellEngineChemicalReactionsInSimulationSpace::PolymeraseRNATranscriptionStartSpecialReactionFunction, "links particle with DNA when found sequence and joins first nucleotide "));
        ChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(160, "POLYMERASE RNA CONTINUE", "Ethanol+DNA+", { { ParticlesKindsManagerObject.GetParticleKindFromStrId("Ethanol")->EntityId, 1, "", false, { CellEngineConfigDataObject.RNAIdentifier, CellEngineConfigDataObject.DNAIdentifier } } }, {}, &CellEngineChemicalReactionsInSimulationSpace::PolymeraseRNATranscriptionContinueSpecialReactionFunction, "links new nucleotide that fits nucleotide in DNA if free nucleotides are found in proximity"));

        //ChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(170, "RIBOSOME RNA START SEQ", "GTP+Ethanol+RNA+", { { ParticlesKindsManagerObject.GetParticleKindFromStrId("Ethanol")->EntityId, 1, "", false },  { ParticlesKindsManagerObject.GetParticleKindFromStrId("ProteinInBuildingProcess")->EntityId, 1, "", false }, { CellEngineConfigDataObject.RNAIdentifier, 1, RNAStartSequence, false }, { ParticlesKindsManagerObject.GetParticleKindFromStrId("M_gtp_c")->EntityId, 1, "", true } }, { }, &CellEngineChemicalReactionsInSimulationSpace::RibosomeTranslationStartSpecialReactionFunction, "links ribosome particle with RNA when found sequence and joins first nucleotide "));
        //ChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(170, "RIBOSOME RNA START SEQ", "GTP+Ethanol+RNA+", { { ParticlesKindsManagerObject.GetParticleKindFromStrId("Ethanol")->EntityId, 1, "", false },  { ParticlesKindsManagerObject.GetParticleKindFromStrId("ProteinInBuildingProcess")->EntityId, 1, "", false }, { CellEngineConfigDataObject.DNAIdentifier, 0, "", false }, { ParticlesKindsManagerObject.GetParticleKindFromStrId("M_gtp_c")->EntityId, 1, "", true } }, { }, &CellEngineChemicalReactionsInSimulationSpace::RibosomeTranslationStartSpecialReactionFunction, "links ribosome particle with RNA when found sequence and joins first nucleotide "));
        ChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(170, "RIBOSOME RNA START SEQ", "GTP+Ethanol+RNA+", { { ParticlesKindsManagerObject.GetParticleKindFromStrId("Ethanol")->EntityId, 1, "", false },  { ParticlesKindsManagerObject.GetParticleKindFromStrId("ProteinInBuildingProcess")->EntityId, 1, "", false }, { CellEngineConfigDataObject.DNAIdentifier, 0, RNAStartSequence, false }, { ParticlesKindsManagerObject.GetParticleKindFromStrId("M_gtp_c")->EntityId, 1, "", true } }, { }, &CellEngineChemicalReactionsInSimulationSpace::RibosomeTranslationStartSpecialReactionFunction, "links ribosome particle with RNA when found sequence and joins first nucleotide "));
        ChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(180, "RIBOSOME RNA CONTINUE", "Ethanol+RNA+", { { ParticlesKindsManagerObject.GetParticleKindFromStrId("Ethanol")->EntityId, 1, "", false, { CellEngineConfigDataObject.ProteinInBuildingProcessIdentifier, CellEngineConfigDataObject.RNAIdentifier } } }, { }, &CellEngineChemicalReactionsInSimulationSpace::RibosomeTranslationContinueSpecialReactionFunction, "links new nucleotide that fits nucleotide in DNA if free nucleotides are found in proximity"));
