...
void CellEngineCompiledDataCreator::AddChemicalReactions()
{
    try
    {
        const string AttachPolymeraseToDNAStartSeq1 = "TATAAT";
        ChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(151, "POLYMERASE RNA START SEQ", "DNA+RNA+rnapol+", { { ParticlesKindsManagerObject.GetParticleKindFromStrId("particle_RNAPolymerase")->EntityId, 1, "", false }, { CellEngineConfigDataObject.DNAIdentifier, 1, AttachPolymeraseToDNAStartSeq1, false, &CheckIfThisIsPromoter }, { CellEngineConfigDataObject.DNAIdentifier, 0, RNAStartSequence, false } }, {}, &CellEngineChemicalReactionsInSimulationSpace::PolymeraseRNATranscriptionFullStartSpecialReactionFunction, "links rna polymerase particle with DNA when found sequence and joins first nucleotide "));
        ChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(152, "POLYMERASE RNA CONTINUE", "DNA+rnapol+", { { ParticlesKindsManagerObject.GetParticleKindFromStrId("particle_RNAPolymerase")->EntityId, 1, "", false, { CellEngineConfigDataObject.RNAIdentifier, CellEngineConfigDataObject.DNAIdentifier } } }, { { ParticlesKindsManagerObject.GetParticleKindFromStrId("m_ppi_c")->EntityId, 1, "", false } }, &CellEngineChemicalReactionsInSimulationSpace::PolymeraseRNATranscriptionContinueEndedByHairpinSpecialReactionFunction, "links new nucleotide that fits nucleotide in DNA if free nucleotides are found in proximity"));
...
void CellEngineCompiledDataCreator::AddTestChemicalReactions()
{
    try
    {
        ...
        ChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(10, "CUT 1 SEQ", "Ethanol+DNA+", { { ParticlesKindsManagerObject.GetParticleKindFromStrId("Ethanol")->EntityId, 1, "", false }, { CellEngineConfigDataObject.DNAIdentifier, 1, DNASequence1ForTestCutLink1, false } }, {}, &CellEngineChemicalReactionsInSimulationSpace::CutDNASingleStrandInChosenPlaceSpecialReactionFunction, "only in presence of chosen sequence of DNA"));
        ...
        ChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(80, "LINK 2 ANY EQU SAME", "Propen+DNA+DNA+", { { ParticlesKindsManagerObject.GetParticleKindFromStrId("Propen")->EntityId, 1, "", false }, { CellEngineConfigDataObject.DNAIdentifier, 1, "ANY", false }, { CellEngineConfigDataObject.DNAIdentifier, 1, "ANY", false } }, {}, &CellEngineChemicalReactionsInSimulationSpace::LinkDNABothStrandsInAnyPlaceSpecialReactionFunction, "links both strands of DNA if they are cut equally in the same place"));

        ChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(100, "CUT CRISPER 1", "Propen+RNA+DNA+", 3, 7, { { ParticlesKindsManagerObject.GetParticleKindFromStrId("Propen")->EntityId, 1, "", false }, { CellEngineConfigDataObject.DNAIdentifier, 1, DNASequenceForTestCutCrisper, false }, { CellEngineConfigDataObject.DNAIdentifier, 0, RNASequenceForTestCutCrisper, false } }, {}, &CellEngineChemicalReactionsInSimulationSpace::CutDNASingleStrandCrisperInChosenPlaceSpecialReactionFunction, "cut crisper of one strand of DNA with RNA as template"));
        ChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(110, "CUT CRISPER 2", "Propen+RNA+DNA+", 3, 7, { { ParticlesKindsManagerObject.GetParticleKindFromStrId("Propen")->EntityId, 1, "", false }, { CellEngineConfigDataObject.DNAIdentifier, 1, DNASequenceForTestCutCrisper, false }, { CellEngineConfigDataObject.DNAIdentifier, 0, RNASequenceForTestCutCrisper, false } }, {}, &CellEngineChemicalReactionsInSimulationSpace::CutDNABothStrandsCrisperInChosenPlaceSpecialReactionFunction, "cut crisper of two strands of DNA with RNA as template"));
        ...
        ChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(160, "POLYMERASE RNA CONTINUE", "Ethanol+DNA+", { { ParticlesKindsManagerObject.GetParticleKindFromStrId("Ethanol")->EntityId, 1, "", false, { CellEngineConfigDataObject.RNAIdentifier, CellEngineConfigDataObject.DNAIdentifier } } }, {}, &CellEngineChemicalReactionsInSimulationSpace::PolymeraseRNATranscriptionContinueEndedByCodonStopSpecialReactionFunction, "links new nucleotide that fits nucleotide in DNA if free nucleotides are found in proximity"));
        ...
        ChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(180, "RIBOSOME RNA CONTINUE", "Ethanol+RNA+", { { ParticlesKindsManagerObject.GetParticleKindFromStrId("Ethanol")->EntityId, 1, "", false, { CellEngineConfigDataObject.ProteinInBuildingProcessIdentifier, CellEngineConfigDataObject.RNAIdentifier } } }, { }, &CellEngineChemicalReactionsInSimulationSpace::RibosomeTranslationContinueSpecialReactionFunction, "links new nucleotide that fits trna in protein if free trna are found in proximity"));
