...
void CellEngineCompiledDataCreator::AddChemicalReactions()
{
    try
    {
        ...
        ChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(151, "POLYMERASE RNA START SEQ", "DNA+RNA+rnapol+", { { ParticlesKindsManagerObject.GetParticleKindFromStrId("particle_RNAPolymerase")->EntityId, 1, "", false }, { CellEngineConfigDataObject.DNAIdentifier, 1, AttachPolymeraseToDNAStartSeq1, false, &CheckIfThisIsPromoter }, { CellEngineConfigDataObject.DNAIdentifier, 0, RNAStartSequence, false } }, {}, &CellEngineChemicalReactionsInSimulationSpace::PolymeraseRNATranscriptionStartSpecialReactionFunction, "links rna polymerase particle with DNA when found sequence and joins first nucleotide "));
