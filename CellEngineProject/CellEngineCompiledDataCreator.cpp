...
void CellEngineCompiledDataCreator::AddChemicalReactions()
{
    try
    {
        ...
        //const string DNASequence1ForTestCutLink2 = "CTCATTTTTTCTAAATTCAGT";
...
//        ChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(42, "CUT 2 SEQ SHIFT 10 3", "CH3CHCH2+DNA+", 10, 3, { { 5, 1, "", false }, { 10001, 1, DNASequence1ForTestCutLink2, false } }, { { 86, 1, "", true } }, &CellEngineChemicalReactionsInSimulationSpace::CutDNAInChosenPlaceSpecialReactionFunction, "cuts both strands when found first sequence plus additional shift in both strands defined by additional parameters shift1=10 shift2=3"));
        ChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(40, "CUT 2 SEQ SHIFT 3 10", "CH3CHCH2+DNA+", 2, 5, { { 5, 1, "", false }, { 10001, 1, DNASequence1ForTestCutLink2, false } }, { { 86, 1, "", true } }, &CellEngineChemicalReactionsInSimulationSpace::CutDNAInChosenPlaceSpecialReactionFunction, "cuts both strands when found first sequence plus additional shift in both strands defined by additional parameters shift1=3 shift=10"));
        ChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(41, "CUT 2 SEQ SHIFT 7 3", "CH3CHCH2+DNA+", 3, 1, { { 5, 1, "", false }, { 10001, 1, DNASequence1ForTestCutLink2, false } }, { { 86, 1, "", true } }, &CellEngineChemicalReactionsInSimulationSpace::CutDNAInChosenPlaceSpecialReactionFunction, "cuts both strands when found first sequence plus additional shift in both strands defined by additional parameters shift1=7 shift2=3"));
        ChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(42, "CUT 2 SEQ SHIFT 10 3", "CH3CHCH2+DNA+", 5, 2, { { 5, 1, "", false }, { 10001, 1, DNASequence1ForTestCutLink2, false } }, { { 86, 1, "", true } }, &CellEngineChemicalReactionsInSimulationSpace::CutDNAInChosenPlaceSpecialReactionFunction, "cuts both strands when found first sequence plus additional shift in both strands defined by additional parameters shift1=10 shift2=3"));
        ...
        //ChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(60, "LINK 2 SEQ COMPLEMENT", "CH3CHCH2+DNA+DNA+", { { 5, 1, "", false }, { 10001, 1, "CTCATTTTTTCTAAATTCAGTTAG", false }, { 10001, 1, "CAATCACT", false } }, {}, &CellEngineChemicalReactionsInSimulationSpace::LinkDNALigaseInChosenPlaceSpecialReactionFunction, "Links both DNA strands if first strand has first sequence and second strand has second sequence and opposite joining strands and complementary"));
        ChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(60, "LINK 2 SEQ COMPLEMENT", "CH3CHCH2+DNA+DNA+", { { 5, 1, "", false }, { 10001, 1, "CTCATTT", false }, { 10001, 1, "TTTCT", false } }, {}, &CellEngineChemicalReactionsInSimulationSpace::LinkDNALigaseInChosenPlaceSpecialReactionFunction, "Links both DNA strands if first strand has first sequence and second strand has second sequence and opposite joining strands and complementary"));
        ...
        //ChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(61, "LINK 2 SEQ COMPLEMENT", "CH3CHCH2+DNA+DNA+", { { 5, 1, "", false }, { 10001, 1, "CTCATTTTTTCTAAATTCAGTTAGCAAT", false }, { 10001, 1, "CACTCCTC", false } }, {}, &CellEngineChemicalReactionsInSimulationSpace::LinkDNALigaseInChosenPlaceSpecialReactionFunction, "Links both DNA strands if first strand has first sequence and second strand has second sequence and opposite joining strands and complementary"));
        //ChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(61, "LINK 2 SEQ COMPLEMENT", "CH3CHCH2+DNA+DNA+", { { 5, 1, "", false }, { 10001, 1, "CTCATTTTTT", false }, { 10001, 1, "CACTCCTC", false } }, {}, &CellEngineChemicalReactionsInSimulationSpace::LinkDNALigaseInChosenPlaceSpecialReactionFunction, "Links both DNA strands if first strand has first sequence and second strand has second sequence and opposite joining strands and complementary"));
        ChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(61, "LINK 2 SEQ COMPLEMENT", "CH3CHCH2+DNA+DNA+", { { 5, 1, "", false }, { 10001, 1, "CTCATTTTTT", false }, { 10001, 1, "CTAAAT", false } }, {}, &CellEngineChemicalReactionsInSimulationSpace::LinkDNALigaseInChosenPlaceSpecialReactionFunction, "Links both DNA strands if first strand has first sequence and second strand has second sequence and opposite joining strands and complementary"));
...
//        ChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(150, "POLYMERASE DNA START SEQ", "CH3CHCH2+DNA+", { { 5, 1, "", false }, { 10001, 1, "CTCATTT", false } }, {}, &CellEngineChemicalReactionsInSimulationSpace::PolymeraseRNAStartSpecialReactionFunction, "links particle with DNA when found sequence and joins first nucleotide "));
//        ChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(160, "POLYMERASE DNA CONTINUE", "CH3CHCH2+DNA+", { { 5, 1, "", false, { CellEngineConfigDataObject.RNAIdentifier, CellEngineConfigDataObject.DNAIdentifier } } }, {}, &CellEngineChemicalReactionsInSimulationSpace::PolymeraseRNAContinueSpecialReactionFunction, "links new nucleotide that fits nucleotide in DNA if free nucleotides are found in proximity"));
        ChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(150, "POLYMERASE DNA START SEQ", "CH3CH2(OH)+DNA+", { { 5, 1, "", false }, { 10001, 1, "CTCATTT", false } }, {}, &CellEngineChemicalReactionsInSimulationSpace::PolymeraseRNAStartSpecialReactionFunction, "links particle with DNA when found sequence and joins first nucleotide "));
