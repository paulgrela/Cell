...
void TestWellStirredChemicalReactionsSimulation(CellEngineWellStirredChemicalReactionsSimulation& CellEngineWellStirredChemicalReactionsSimulationObjectObject)
{
    ...
    CellEngineChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(1001, "", "C6H12O6 + O2 + ", {{1, 1, "", true }, {2, 6, "", true} }, {{3, 6, "", true }, {0, 6, "", true } }, nullptr));
    CellEngineChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(1002, "", "CH2CH2 + H2O + ", {{4, 1, "", true }, {0, 1, "", true} }, {{5, 1, "", true } }, nullptr));
    CellEngineChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(1003, "", "CH3CHCH2 + HX + ", {{6, 1, "", true }, {7, 1, "", true} }, {{8, 1, "", true } }, nullptr));
    CellEngineChemicalReactionsManagerObject.AddChemicalReaction(ChemicalReaction(1004, "", "CH2CH2 + O + ", {{4, 1, "", true }, {2, 1, "", true} }, {{10, 1, "", true } }, nullptr));
}
