...
void TestWellStirredChemicalReactionsSimulation(CellEngineWellStirredChemicalReactionsSimulation& CellEngineWellStirredChemicalReactionsSimulationObjectObject)
{
    ...
    CellEngineWellStirredChemicalReactionsSimulationObjectObject.AddChemicalReaction(Reaction(1003, "", "CH3CHCH2 + HX + ", { { 6, 1, "", true }, { 7, 1, "", true} }, { { 8, 1, "", true } }, nullptr));
    CellEngineWellStirredChemicalReactionsSimulationObjectObject.AddChemicalReaction(Reaction(1004, "", "CH2CH2 + O + ", { { 4, 1, "", true }, { 2, 1, "", true} }, { { 10, 1, "", true } }, nullptr));
}
