...
void TestWellStirredChemicalReactionsSimulation(CellEngineWellStirredChemicalReactionsSimulation& CellEngineWellStirredChemicalReactionsSimulationObjectObject)
{
    ...
    ParticlesKindsManagerObject.AddParticleKind({ 2, "Oxygen", "0", 10 });
    ...
    CellEngineWellStirredChemicalReactionsSimulationObjectObject.AddChemicalReaction(Reaction("C6H12O6 + O6 + ", { {1, 1, true}, {2, 6, true} }, { {3, 6, true}, {2, 6, true} }));
    CellEngineWellStirredChemicalReactionsSimulationObjectObject.AddChemicalReaction(Reaction("CH2CH2 + H2O + ", { {4, 1, true}, {0, 1, true} }, { {5, 1, true} }));
    CellEngineWellStirredChemicalReactionsSimulationObjectObject.AddChemicalReaction(Reaction("CH3CHCH2 + HX + ", { {6, 1, true}, {7, 1, true} }, { {8, 1, true} }));
    CellEngineWellStirredChemicalReactionsSimulationObjectObject.AddChemicalReaction(Reaction("CH2CH2 + O + ", { {9, 1, true}, {2, 1, true} }, { {10, 1, true} }));
}
