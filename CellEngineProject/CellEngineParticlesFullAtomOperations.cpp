                    ...
                    if (Thread1Pos != Thread2Pos)
                    {
                        for (UnsignedInt NeighborProcessIndex = 0; NeighborProcessIndex < NumberOfAllNeighbors; NeighborProcessIndex++)
                        {
                            ...
                            //if (NeighborThreadsIndexes[NeighborProcessIndex] == Thread2Pos)
                            {
                                ...
                                const auto Thread1Index = CellEngineDataFileObjectPointer->CellEngineSimulationSpaceForThreadsObjectsPointer[Thread1Pos.ThreadPosX - 1][Thread1Pos.ThreadPosY - 1][Thread1Pos.ThreadPosZ - 1]->CurrentThreadIndex - 1;
                                const auto Thread2Index = CellEngineDataFileObjectPointer->CellEngineSimulationSpaceForThreadsObjectsPointer[Thread2Pos.ThreadPosX - 1][Thread2Pos.ThreadPosY - 1][Thread2Pos.ThreadPosZ - 1]->CurrentThreadIndex - 1;

                                //VectorOfParticlesToSendToNeighborThreads[NeighborProcessIndex].emplace_back(ParticleSenderStruct{ .ParticleIndex = ParticleObject.Index, .ParticleKindId = ParticleObject.EntityId, .SenderProcessIndex = static_cast<int>(Thread1Index), .ReceiverProcessIndex = static_cast<int>(Thread2Index), .SectorPos = { static_cast<uint16_t>(SectorPosX2), static_cast<uint16_t>(SectorPosY2), static_cast<uint16_t>(SectorPosZ2) }, .NewPosition = { ParticleObject.Center.X, ParticleObject.Center.Y, ParticleObject.Center.Z }});
                                //CellEngineDataFileObjectPointer->CellEngineSimulationSpaceForThreadsObjectsPointer[Thread2Pos.ThreadPosX - 1][Thread2Pos.ThreadPosY - 1][Thread2Pos.ThreadPosZ - 1]->VectorOfParticlesToSendToNeighborProcessesOrThreads[NeighborProcessIndex].emplace_back(ParticleSenderStruct{ .ParticleIndex = ParticleObject.Index, .ParticleKindId = ParticleObject.EntityId, .SenderProcessIndex = static_cast<int>(Thread1Index), .ReceiverProcessIndex = static_cast<int>(Thread2Index), .SectorPos = { static_cast<uint16_t>(SectorPosX2), static_cast<uint16_t>(SectorPosY2), static_cast<uint16_t>(SectorPosZ2) }, .NewPosition = { ParticleObject.Center.X, ParticleObject.Center.Y, ParticleObject.Center.Z }});

                                //TU BLAD BO MOZE NA RAZ WSTAWIAC WIELE WATKOW A NIE MA SEKCJI KRYTYCZNEJ - czy wiele
                                //CellEngineDataFileObjectPointer->CellEngineSimulationSpaceForThreadsObjectsPointer[CurrentThreadPos.ThreadPosX - 1][CurrentThreadPos.ThreadPosY - 1][CurrentThreadPos.ThreadPosZ - 1]->VectorOfParticlesToSendToNeighborProcessesOrThreads[NeighborProcessIndex].emplace_back(ParticleSenderStruct{ .ParticleIndex = ParticleObject.Index, .ParticleKindId = ParticleObject.EntityId, .SenderProcessIndex = static_cast<int>(Thread1Index), .ReceiverProcessIndex = static_cast<int>(Thread2Index), .SectorPos = { static_cast<uint16_t>(SectorPosX2), static_cast<uint16_t>(SectorPosY2), static_cast<uint16_t>(SectorPosZ2) }, .NewPosition = { ParticleObject.Center.X, ParticleObject.Center.Y, ParticleObject.Center.Z }});
                                VectorOfParticlesToSendToNeighborThreads[NeighborProcessIndex].emplace_back(ParticleSenderStruct{ .ParticleIndex = ParticleObject.Index, .ParticleKindId = ParticleObject.EntityId, .SenderProcessIndex = static_cast<int>(Thread1Index), .ReceiverProcessIndex = static_cast<int>(Thread2Index), .SectorPos = { static_cast<uint16_t>(SectorPosX2), static_cast<uint16_t>(SectorPosY2), static_cast<uint16_t>(SectorPosZ2) }, .NewPosition = { ParticleObject.Center.X, ParticleObject.Center.Y, ParticleObject.Center.Z }});
