...
bool CellEngineNucleicAcidsChemicalReactionsInSimulationSpace::CompareFitnessOfRNASequenceByNucleotidesLoop(ComparisonType TypeOfComparison, const ParticleKindForReaction& ParticleKindForReactionObject, Particle& ParticleObjectForReaction, bool RNAInOneParticle)
{
    ...
    try
    {
        ...
        {
            NucleotidesSequenceToCompareString = ParticleObjectForReaction.SequenceStr;
            for (auto &NucleotidesSequenceToCompareStringChar: NucleotidesSequenceToCompareString)
                NucleotidesSequenceToCompareVector.emplace_back(CellEngineUseful::GetChainIdFromLetterForDNAorRNA(NucleotidesSequenceToCompareStringChar));
        }
